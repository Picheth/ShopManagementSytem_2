...
type ContactImportPreviewProps = {
	validRows: any[];
	invalidRows: any[];
	onConfirm: () => void;
	onClose: () => void;
...
export function ContactImportPreview({ validRows, invalidRows, onConfirm, onClose }: ContactImportPreviewProps) {
	return (
		<div style={{ background: "#fff", padding: 24, borderRadius: 8, boxShadow: "0 2px 8px #ccc" }}>
			<h2>Contact Import Preview</h2>
